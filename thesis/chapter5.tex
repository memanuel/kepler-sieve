...
% \end{center}
% \caption{Distance to the nearest asteroid for 125 orbital elements trained on known asteroids.}
% \label{fig:RandomKnownNearAst}
% \end{figure}
% \clearpage
...
% Figure ~\ref{fig:TrainRandomKnown} shows the training results for the fitted elements: number of hits and log likliehood.
% Figure ~\ref{fig:RandomKnownNearAst} shows the distance to the nearest asteroid in both metrics (mean distance in AU and covariance).
Figure ~\ref{fig:RandomRandomKnownNear} shows training results for the fitted elements.
...
% \end{center}
% \caption{Training quality for fitted orbital elements for 9 new asteroid candidates.}
% \label{fig:TrainRandomUnknown}
% \end{figure}
% \clearpage
...
% \end{center}
% \caption{Distance to the nearest asteroid for 9 new asteroid candidates.}
% \label{fig:RandomUnknownNearAst}
% \end{figure}
...
% Figures ~\ref{fig:TrainRandomUnknown} and ~\ref{fig:TrainRandomUnkownNearAst}
...
Element \tty{178421} is stringing together four detections of object ZTF18aboluox and 4 detections of object ZTF18acewaex.
...
Element \tty{3308} is piecing together 6 detections of ZTFV18abtpdzg and 2 detections of ZTF18abskzw.
...
\subsection{Incorporating Additonal Data}
...
\subsection{Incorporate Magnitude}
I developed code in the \tty{AsteroidSearcch} model to predict the magnitude of a detection using the H-G model.
...
\subsection{Rebuild the Known Asteroid Catalogue}
