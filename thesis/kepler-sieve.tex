...
very close to some of the observed directions.
The candidate elements and the parameters describing a mixture probability distribution are jointly optimized using gradient descent.
...
I would like to thank my secondary advisor, Chris Rycroft, for guiding me through a paper in Applied Math 225 in which I explored
numerical integrators for solving Solar System orbits.\\
I would like to thank Matt Holman and Matt Payne from the Center for Astrophysics (CFA) 
