...
\begin{samepage}
\begin{itemize}
\item $a$, the semi-major axis; named \tty{a} in JPL and \tty{REBOUND}
\item $e$, the eccentricity; named \tty{e} in both systems
\item $i$, the inclination; named \tty{i} in JPL and \tty{inc} in \tty{REBOUND}
\item $\Omega$, the longitude of the ascending node; named \tty{node} in JPL and \tty{Omega} in \tty{REBOUND}
\item $\omega$, the argument of perihelion; named \tty{peri} in JPL and \tty{omega} in \tty{REBOUND}
\item $f$, the true anomaly; named \tty{f} in \tty{REBOUND}; not quoted directly by JPL
