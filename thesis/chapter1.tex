...
% \begin{figure}
% \begin{center}
% \includegraphics[width=0.40\textwidth]{../figs/web/orbital-elements-wikipedia.png}
% \end{center}
...
\begin{itemize}
\item $a$, the semi-major axis
\item $e$, the eccentricity
\item $i$, the inclination
\item $\Omega$, the longitude of the ascending node
\item $\omega$, the argument of perihelion
\item $f$, the true anomaly
\item $M$, the mean anomaly
...
The mean anomaly and eccenctric anomalies are related by the famous 
...
\tan \left(\frac{f}{2} \right) &= \sqrt{\frac{1+e}{1-e}} \tan \left( \frac{E}{2} \right) &\textrm{true to eccentric}
\end{align*}

\begin{figure}
\begin{center}
\includegraphics[width=0.40\textwidth]{orbital_anomalies.png}
\end{center}
...
It is part of the sexagesimal system that includes the more familiars degrees.
One arc second is defined as $1 / 3600$ of one degree or qquivalently as $\pi / 648000$ radians.}
...
\label{fig:PlanetIntegrationError}
\end{table}
...
Figure ~\ref{fig:PlanetIntegrationError} summarizes the results.
