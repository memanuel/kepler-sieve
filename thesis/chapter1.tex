...
The code to do this is in \tty{asteroid\_integrate.py}.
There are a few parts that are not obvious and worth explanation. \\
...
\item \textbf{G} is $G$ parameter (sensitivity of brightness to phase angle)
