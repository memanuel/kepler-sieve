...
\subsection{Fitting Unperturbed Elements with Uninformative Mixture Parameters}
...
I've developed a number of visualizations to assess the results of training as it progresses and at the end.
...
\subsection{Comparing Candidate Elements to the Nearest Asteroid}
I spent some time trying to develop a metric comparing a set of candidate orbital elements to the elements of a known asteroid.
While orbital elements are convenient for intuition and calculating orbits, 
there isn't an obvious distance metric we can put on them that makes a lot of sense.
...
This is implemenented in the same module with the function \tty{elt\_q\_norm} and \tty{nearest\_ast\elt_\cov}.
