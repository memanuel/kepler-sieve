CREATE OR REPLACE TABLE KS.DetectionTime(
    ...
    SourceDetectionTimeID INT NOT NULL
    	COMMENT "Foreign key to source DetectionTime table, e.g. ZTF.DetectionTime",
	-- Position of the observer q = [qx, qy, qz]; includes topos adjustment
	...
	-- Velocity of the observer v = [vx, vy, vz]; includes topos adjustment
	vObs_x DOUBLE NOT NULL
		COMMENT "Velocity of observatory (x coordinate) in AU/day in the barcycentric mean ecliptic frame; includes topos adjustment",
	vObs_y DOUBLE NOT NULL
		COMMENT "Velocity of observatory (y coordinate) in AU/day in the barcycentric mean ecliptic frame; includes topos adjustment",
	vObs_z DOUBLE NOT NULL
		COMMENT "Velocity of observatory (z coordinate) in AU/day in the barcycentric mean ecliptic frame; includes topos adjustment",       
	-- Position of the Sun = [Sun_x, Sun_y, Sun_z]
    qSun_x DOUBLE NOT NULL
        COMMENT "Position of the sun (x coordinate) in AU in the barcycentric mean ecliptic frame",
    qSun_y DOUBLE NOT NULL
        COMMENT "Position of the sun (y coordinate) in AU in the barcycentric mean ecliptic frame",
    qSun_z DOUBLE NOT NULL
        COMMENT "Position of the sun (z coordinate) in AU in the barcycentric mean ecliptic frame",
	-- Velocity of the Sun = [Sun_x, Sun_y, Sun_z]
    vSun_x DOUBLE NOT NULL
        COMMENT "Velocity of the sun (x coordinate) in AU in the barcycentric mean ecliptic frame",
    vSun_y DOUBLE NOT NULL
        COMMENT "Velocity of the sun (y coordinate) in AU in the barcycentric mean ecliptic frame",
    vSun_z DOUBLE NOT NULL
        COMMENT "Velocity of the sun (z coordinate) in AU in the barcycentric mean ecliptic frame",
